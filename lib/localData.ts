...
export const LOCAL_USERS: User[] = [
  { id: "u1", name: "Richmond", email: "rich@example.com", password: "password" }
];
...
export const DOCTORS = [
  { id: "d1", name: "Dr. Afua Mensah", speciality: "General Practitioner", rating: 4.8, city: "Accra" },
  { id: "d2", name: "Dr. Kwesi Owusu", speciality: "Pediatrics", rating: 4.6, city: "Tema" },
  { id: "d3", name: "Dr. Akosua Sarpong", speciality: "Internal Medicine", rating: 4.7, city: "Accra" }
];
