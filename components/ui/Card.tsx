...
export default function Card({ title, subtitle, children, style }: {
  title?: string; subtitle?: string; children?: ReactNode; style?: ViewStyle | ViewStyle[];
}) {
  const t = useAppTheme();
  return (
...
const styles = StyleSheet.create({
  card: { borderWidth: StyleSheet.hairlineWidth, borderRadius: radius.xl, padding: space.lg },
